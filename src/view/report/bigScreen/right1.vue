<template>
  <div class="right1_body">
    ...
    <Charts v-if="ifshow" :id="'chart3'" :height="'210px'" :chartType="'bar'" :chartData="chart_obj"></Charts>
    ...
    <Charts v-if="ifshow" :id="'chart4'" :height="'188px'" :chartType="'pie'" :chartData="chart_obj"></Charts>
  </div>
</template>
